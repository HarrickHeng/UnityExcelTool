...
namespace ExcelTool
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("全部生成完毕，按下回车键退出");
            Console.ReadLine();
        }
        ...
        private static void CreateServerEntity(string fileName, string[,] dataArr)
        {
            ...
            sbr.Append("//备    注：此代码为工具生成 请勿手工修改\r\n");
            sbr.Append("//===================================================\r\n");
            sbr.Append("using HHServer.Core.DataTableBase;\r\n");
            sbr.Append("\r\n");
            sbr.Append("namespace HHServer.Model.DataTable\r\n");
            sbr.Append("{\r\n");
            sbr.Append("    /// <summary>\r\n");
            sbr.AppendFormat("    /// {0}实体\r\n", fileName);
            sbr.Append("    /// </summary>\r\n");
        ...
        private static void CreateDBModel(string fileName, string[,] dataArr)
        {
            ...
            sbr.Append("    {\r\n");
            sbr.Append("        var rows = ms.ReadInt();\r\n");
            sbr.Append("        var columns = ms.ReadInt();\r\n");
            sbr.Append("\r\n");
            sbr.Append("        for (var i = 0; i < rows; i++)\r\n");
            sbr.Append("        {\r\n");
            sbr.AppendFormat("            var entity = new {0}Entity\r\n", fileName);
            sbr.Append("            {\r\n");
            for (int i = 0; i < dataArr.GetLength(0); i++)
            {
            ...
            sbr.Append("            mDic[entity.Id] = entity;\r\n");
            sbr.Append("        }\r\n");
            sbr.Append("    }\r\n");
            ...
            sbr.AppendFormat("    CS.HH.GameEntry.Lua:LoadDataTable(\"{0}\", this.LoadFormMS);\r\n", fileName);
            sbr.Append("end\r\n");
            sbr.Append("\r\n");
        ...
        private static void CreateServerDBModel(string fileName, string[,] dataArr)
        {
            ...
            sbr.Append("//===================================================\r\n");
            sbr.Append("using HHServer.Core.DataTableBase;\r\n");
            sbr.Append("using HHServer.Core.Common;\r\n");
            sbr.Append("\r\n");
            sbr.Append("namespace HHServer.Model.DataTable\r\n");
            sbr.Append("{\r\n");
            sbr.Append("    /// <summary>\r\n");
